...
if (($dow > 2) && ($dow < 6)){
$week = $week -1;
echo "<i><h3>Last Week's Picks Displayed Until Saturday at 1pm</h3></i>";
}
...
echo "<h2> Stats for $username As of Week $week</h2>";
echo "<div class='table-responsive table-condensed'>";
	echo "<table width = '200' id ='overallrecord' class='table-striped'>";
	echo "<thead style='font-weight:bold';>";
	echo "<tr><td>"."Wins"."</td><td>"."Losses"."</td><td>";
	echo "</thead>";
	echo "<tbody>";
