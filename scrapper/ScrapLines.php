...
$dom->loadHTMLFile('http://www.westgatedestinations.com/nevada/las-vegas/westgate-las-vegas-hotel-casino/casino/supercontest-weekly-card');
libxml_clear_errors();
...
$element='//*/table[@class="csvTable"]/tbody/tr';
...
{ 
	...
	$theline = str_replace("1/2", ".5", $theline);
